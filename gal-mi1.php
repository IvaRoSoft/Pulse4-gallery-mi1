<style>
.<?php echo $tag_var2; ?> img {
	margin-right: 20px;
	margin-bottom: 20px;
	height: <?php echo $th_height = $tag_var3 ?>px;
}
</style>
...
<script>
$('.<?php echo $tag_var2; ?>').each(function() {
    $(this).magnificPopup({
        delegate: 'a',
        type: 'image',
        disableOn: 10,
...
<?php unset( $tag_var2,$tag_var3,$th_height); ?>